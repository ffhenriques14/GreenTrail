    ...
    <div class="navbar-body pt-3 " >
        <nav class="navbar col-12">
            <div class="logo-nav d-flex justify-content-start align-items-start col-6 ps-5 ">
                <a href="index.php">
                    <img src="images/logo_white.svg" alt="" style="height: 50px; " class="logo-nav">
                </a>
            </div>
            <div class="container-fluid d-flex justify-content-end col-12 col-sm-6">
                <div class="row d-flex align-items-center">
                    ...
                    if ($fetch['image'] == '') {
                        echo ' <div class="col-3 ms-3 me-1 d-flex justify-content-center" ><a href="profile.php"><img src="images/default-avatar.png" style="width:50px; height: 50px;"></a></div>';
                    } else {
                        echo '<div class="col-3 ms-3 me-1  d-flex justify-content-center" ><a href="profile.php"><img src="uploaded_img/' . $fetch['image'] . '" style="width:50px; height: 50px; border-radius: 100px;"></a></div>';
                    }
                    ?>
                    <div>
